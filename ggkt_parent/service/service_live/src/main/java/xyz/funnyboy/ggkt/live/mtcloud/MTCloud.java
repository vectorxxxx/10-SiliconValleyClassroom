...
package xyz.funnyboy.ggkt.live.mtcloud;
...
import xyz.funnyboy.ggkt.live.mtcloud.utils.MD5Util;
...
public class MTCloud
{
     ...
     * 合作方ID： 合作方在欢拓平台的唯一ID
     */
    public String openID = "62803";

    /**
     * 合作方秘钥： 合作方ID对应的参数加密秘钥
     */
    public String openToken = "1f3d22e25c314f69a7733cf61c51b9ae";
    ...
    public String userAccessKey(String uid, String nickname, String role, String roomid, int expire) throws Exception {
        ...
        String accessAuth = this.base64UrlEncode(JSONObject
                .fromObject(params)
                .toString());
        return accessAuth;
    }
    ...
    public String userAccessKey(String uid, String nickname, String role, String roomid, int expire, HashMap<Object, Object> options) throws Exception {
        ...
        params.put("roomid", roomid);
        params.put("expire", expire);
        params.put("options", JSONObject
                .fromObject(options)
                .toString());

        params.put("sign", this.generateSign(params));
        String accessAuth = JSONObject
                .fromObject(params)
                .toString();
    ...
    public String getManagerUrl(String roomid, int expire, HashMap<Object, Object> options) throws Exception {
        ...
        if (options.containsKey("nickname")) {
            params.put("nickname", options
                    .get("nickname")
                    .toString());
        }

        if (options.containsKey("role")) {
            params.put("role", options
                    .get("role")
                    .toString());
        }
     ...
     * @throws Exception
     */
    public String liveVoteAdd(String roomid, String uid, String nickname, String title, String label, ArrayList op, int type, int optional, String answer, String image,
                              HashMap<Object, Object> options) throws Exception {
        HashMap<Object, Object> params = new HashMap<Object, Object>();
        params.put("roomid", roomid);
        params.put("uid", uid);
        params.put("nickname", nickname);
     ...
     * @return
     */
    public String courseAdd(String course_name, String account, String start_time, String end_time, String nickname, String accountIntro, HashMap<Object, Object> options)
            throws Exception {
        HashMap<Object, Object> params = new HashMap<Object, Object>();
     ...
     * @param HashMap options 		可选参数
     */
    public String courseUpdate(String course_id, String account, String course_name, String start_time, String end_time, String nickname, String accountIntro,
                               HashMap<Object, Object> options) throws Exception {
        HashMap<Object, Object> params = new HashMap<Object, Object>();
        params.put("course_id", course_id);
        params.put("course_name", course_name);
     ...
     */
    public String courseVoteAdd(String course_id, String uid, String nickname, String title, String label, ArrayList op, int type, int optional, String answer, String image,
                                HashMap<Object, Object> options) throws Exception {
        HashMap<Object, Object> params = new HashMap<Object, Object>();
        params.put("course_id", course_id);
        params.put("uid", uid);
     ...
     */
    public String documentThirdBinding(int bid, String name, String url, int filesize, int duration, String ext, int type, String thumbnail, int courseId, int roomId)
            throws Exception {
        HashMap<Object, Object> params = new HashMap<Object, Object>();
        params.put("bid", bid);
        params.put("name", name);
     ...
     * @throws Exception
     */
    public String videoUpload(String fileName, String account, int accountType, String title, String nickname, String accountIntro, HashMap<Object, Object> course)
            throws Exception {
        String retval = "";
        String fileMd5 = "";
     ...
     * @throws Exception
     */
    public String videoSegmentUpload(String fileName, String account, int accountType, String title, String nickname, String accountIntro, HashMap<Object, Object> course)
            throws Exception {
        String retval = "";
        String fileMd5 = "";
        ...
        if (resJson.getInt("code") == MTCloud.CODE_SUCCESS) {
            ...
            File tempDir = new File(file
                    .getParentFile()
                    .toString() + fileSeparator + "mtcloudTemp" + fileMd5 + fileSeparator);
            if (!tempDir.exists()) {
                tempDir.mkdirs();
            }
            ...
            // 取得被分割后的小文件的数目
            int num = (fileLength % size != 0) ?
                      (int) (fileLength / size + 1) :
                      (int) (fileLength / size);
            ...
            for (int i = 0; i < num; i++) {
                ...
                Part[] parts = {new FilePart("filedata", outFile), new StringPart("chunk", (i + 1) + ""), new StringPart("chunks", num + ""), new StringPart("md5", fileMd5),
     ...
     * @return 成功时返回格式：{"code":0,"data":{"1v1":[{"date":"05-08","duration":31},{"date":"05-09","duration":89},...],"1v6":[{"date":"05-08","duration":96},...],"1v16":[{"date":"05
     * -08","duration":96},...],"desktop":[{"date":"05-08","duration":175},...]}}，duration时长单位为分钟
     */
     ...
     * @param string target 登录成功后跳转的目标，形式：类型-ID 如跳到课程ID为"123456"的页面：course-123456
    ...
    public String call(String cmd, HashMap<Object, Object> params, String HttpMethod, HashMap<Object, Object> files) throws Exception {
        ...
        sysParams.put("params", URLEncoder.encode(JSONObject
                .fromObject(params)
                .toString(), "UTF-8"));
        //签名
