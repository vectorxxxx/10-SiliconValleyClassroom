  ...
  <div class="app-container">
    ...
    <el-dialog title="添加/修改" :visible.sync="dialogVisible" width="60%">
      <el-form ref="flashPromotionForm" label-width="150px" size="small" style="padding-right: 40px;">
        ...
        <el-form-item v-if="liveCourse.id === ''" label="直播讲师登录密码">
    ...
    <el-dialog title="查看账号" :visible.sync="accountDialogVisible" width="60%">
      <el-form ref="accountForm" label-width="150px" size="small" style="padding-right: 40px;">
        ...
        <div style="margin-left: 40px;">
          ...
          <el-row style="height:35px;">
            <el-co>
              <span class="spd-info">助教登录链接：</span>
              <span class="spd-info">https://live.zhibodun.com/live/courseLogin.php?course_id={{
                liveCourseAccount.courseId
              }}&role=admin</span>
            </el-co>
        ...
        <div style="margin-left: 40px;">
          ...
          <el-row style="height:35px;">
            <el-co>
              <span class="spd-info">观看链接：</span>
              <span class="spd-info">http://vectorx.free.idcfengye.com/#/liveInfo/{{ liveCourseAccount.courseId }}</span>
            </el-co>
          </el-row>
          <el-row style="height:35px;">
            <el-col>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button size="small" @click="accountDialogVisible = false">关 闭</el-button>
      </span>
    </el-dialog>
  </div>
</template>
